 ...
 *  content (widgets such as QLabel) are automatically deleted at end of program. In this app,
 *  Mainwindow functionality has been expanded to create a Particles on a Board program
 */
